...
# Note: this is hard coded for a last month of Feb 2022 (first month of pandemic is Feb 2020)
...
for (i in 1:nrow(shares)){
    ...
    # note 23 and 24 and 143 will have to be increased for every additional month of data after Feb 2021
    avgPan <- mean(df[(length(df) - 23):length(df)]) 
    avgPre <- mean(df[(length(df) - 143):(length(df) - 24)]) 
